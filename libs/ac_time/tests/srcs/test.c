...
ac_bool test_time(void) {
  ...
  ac_ticks_to_duration_str(ticks, LEADING0, 1, buff, AC_ARRAY_COUNT(buff));
  ...
  ac_ticks_to_duration_str(ticks, LEADING0, 2, buff, AC_ARRAY_COUNT(buff));
  ...
  ac_ticks_to_duration_str(ticks, LEADING0, 10, buff, AC_ARRAY_COUNT(buff));
  ...
  // Test Years, Days, Hours, Seconds with LEADING0 and NO_LEADING0
  ...
  ac_ticks_to_duration_str(ticks, NO_LEADING0, 1, buff, AC_ARRAY_COUNT(buff));
  ac_printf("ac_ticks_to_duration_str(1d0h1m, NO_LEADING0, 1)=%s\n", buff);
  ...
  ac_ticks_to_duration_str(ticks, NO_LEADING0, 1, buff, AC_ARRAY_COUNT(buff));
  ac_printf("ac_ticks_to_duration_str(1m2.1s, NO_LEADING0, 1)=%s\n", buff);
