...
#ifndef SADIE_LIBS_AC_INET_LINK_INCS_AC_INET_HTON_H
#define SADIE_LIBS_AC_INET_LINK_INCS_AC_INET_HTON_H
...
#error "ac_inet_hton.h: AC_ARCH_BYTE_ORDER is not little or big endian"
