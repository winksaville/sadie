...
ac_bool test_cpuid() {
  ...
  ac_printf("EDX:\n");
  ac_printf(" FPU=%b\n", AC_GET_BITS(ac_u32, out_edx, 0, 1));
  ac_printf(" VME=%b\n", AC_GET_BITS(ac_u32, out_edx, 1, 1));
  ac_printf(" DE=%b\n", AC_GET_BITS(ac_u32, out_edx, 2, 1));
  ac_printf(" PSE=%b\n", AC_GET_BITS(ac_u32, out_edx, 3, 1));
  ac_printf(" TSC=%b\n", AC_GET_BITS(ac_u32, out_edx, 4, 1));
  ac_printf(" MSR=%b\n", AC_GET_BITS(ac_u32, out_edx, 5, 1));
  ac_printf(" PAE=%b\n", AC_GET_BITS(ac_u32, out_edx, 6, 1));
  ac_printf(" MCE=%b\n", AC_GET_BITS(ac_u32, out_edx, 7, 1));
  ac_printf(" CX8=%b\n", AC_GET_BITS(ac_u32, out_edx, 8, 1));
  ac_printf(" APIC=%b\n", AC_GET_BITS(ac_u32, out_edx, 9, 1));
  ac_printf(" RESERVED_B10=%b\n", AC_GET_BITS(ac_u32, out_edx, 10, 1));
  ac_printf(" SEP=%b\n", AC_GET_BITS(ac_u32, out_edx, 11, 1));
  ac_printf(" MTRR=%b\n", AC_GET_BITS(ac_u32, out_edx, 12, 1));
  ac_printf(" PGE=%b\n", AC_GET_BITS(ac_u32, out_edx, 13, 1));
  ac_printf(" MCA=%b\n", AC_GET_BITS(ac_u32, out_edx, 14, 1));
  ac_printf(" CMOV=%b\n", AC_GET_BITS(ac_u32, out_edx, 15, 1));
  ac_printf(" PAT=%b\n", AC_GET_BITS(ac_u32, out_edx, 16, 1));
  ac_printf(" PSE-36=%b\n", AC_GET_BITS(ac_u32, out_edx, 17, 1));
  ac_printf(" PSN=%b\n", AC_GET_BITS(ac_u32, out_edx, 18, 1));
  ac_printf(" CFLUSH=%b\n", AC_GET_BITS(ac_u32, out_edx, 19, 1));
  ac_printf(" RESERVED_B20=%b\n", AC_GET_BITS(ac_u32, out_edx, 20, 1));
  ac_printf(" DS=%b\n", AC_GET_BITS(ac_u32, out_edx, 21 , 1));
  ac_printf(" ACPI-Thermal Monitor and Clock Ctrl=%b\n", AC_GET_BITS(ac_u32, out_edx, 22 , 1));
  ac_printf(" MMX=%b\n", AC_GET_BITS(ac_u32, out_edx, 23, 1));
  ac_printf(" FXSR-FXSAVE/FXRSTOR=%b\n", AC_GET_BITS(ac_u32, out_edx, 24, 1));
  ac_printf(" SSE=%b\n", AC_GET_BITS(ac_u32, out_edx, 25, 1));
  ac_printf(" SSE2=%b\n", AC_GET_BITS(ac_u32, out_edx, 26, 1));
  ac_printf(" SS=%b\n", AC_GET_BITS(ac_u32, out_edx, 27, 1));
  ac_printf(" HTT=%b\n", AC_GET_BITS(ac_u32, out_edx, 28, 1));
  ac_printf(" TM=%b\n", AC_GET_BITS(ac_u32, out_edx, 29, 1));
  ac_printf(" RESERVED_B30=%b\n", AC_GET_BITS(ac_u32, out_edx, 30, 1));
